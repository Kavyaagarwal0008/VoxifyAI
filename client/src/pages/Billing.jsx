    ...
    <div className="min-h-screen bg-[#f7f8fc] px-4 py-10">
      <div className="max-w-5xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-10">
                {/* Free Plan */}
            <div className="bg-white rounded-3xl p-8 border border-gray-300 shadow-sm">
            ...
            {/* Pro */}
            <div className="bg-gradient-to-r from-purple-600 to-emerald-600  rounded-3xl p-8 text-white shadow-lg">
                <h2 className="text-2xl font-bold text-[#081028]">
                    Pro Plan 
                ...
                <ul className="mt-6 space-y-4 opacity-90">
                    ...
                    <li>Advance AI Voice Assistant</li>
                ...
                <button 
                onClick={handlePay}
                disabled={user?.plan ==="pro"} className={`mt-8 h-14 w-full rounded-2xl font-semibold transition ${user?.plan==="pro" ? "bg-emerald-200 text-black cursor-default" : "bg-white text-[#081028] cursor-pointer"}`}>
