                            ...
                            <div className='mt-10 space-y-5'>
                                {
                                    FEATURES.map(({icon, title, desc},index)=>(
                                        <div key={index} className='flex gap-5 rounded-3xl border border-black/5 bg-[#f8fafc] p-5' >
                                            ...
                                            <div className='min-w-[60px] h-[60px] rounded-2xl bg-gradient-to-r from-purple-500 to bg-emerald-500 text-white text-2xl flex items-center justify-center shadow-[0_10px_30px_rgba(139,92,246,0.20)]'>
                                                {icon}
                                            </div>
                                            <div>
