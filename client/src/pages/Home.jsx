...
const STEPS = [
    ...
    },
    {
        ...
        desc:"Ass business details and personalize responses.",
    },
    {
        step:"04",
                ...
                <div className='relative max-w-6xl mx-auto'>
                    ...
                    <div className='text-center mt-10 sm:mt-12'>
                        ...
                        <p className='max-w-2xl mx-auto mt-7 text-sm sm:text-lg lg:text-xl text-[#64748b] leading-relaxed px-2'>
                            Create a smart voice-enabled assistant that talks to visitors, answer questions and help users navigate your website instantly.
                ...
                <div className='max-w-6xl mx-auto flex flex-col sm:flex-row items-center justify-between gap-5 text-center sm:text-left'>
                    <div>
                        <div onClick={()=> navigate("/")} className="flex items-center gap-2.5">
                            ...
                            <h1 className="font-bold text-xl text-gray-100 leading-none">Voxify{" "}<span className="text-transparent bg-clip-text bg-gradient-to-r from-purple-500 to-emerald-500">AI</span></h1>
                        </div>
                    ...
                    <p className='text-gray-500 text-sm'>
                        © {new Date().getFullYear()} VoxifyAI. All rights reserved.
                    </p>
